  ...
  return (
    <div className="rounded-xl border border-slate-800/60 bg-slate-950/50 p-4 shadow-sm">
      ...
      <div
        ...
        onDrop={onDrop}
        className={`flex flex-col items-center justify-center rounded-lg border-2 border-dashed transition-colors duration-200 ${
          dragOver 
      ...
      >
        ...
        <label className="inline-flex cursor-pointer items-center justify-center rounded-lg bg-emerald-500 px-4 py-2 text-xs font-semibold text-slate-950 hover:bg-emerald-400 active:bg-emerald-500 transition-colors duration-200">
          ...
          <div className="mt-3 rounded-lg border border-emerald-500/30 bg-emerald-500/10 px-3 py-2 text-xs">
            <div className="flex items-center justify-between gap-2">
              ...
              <button
                ...
                className="ml-2 rounded-lg p-1 text-emerald-300 hover:text-emerald-200 hover:bg-emerald-500/20 transition-colors duration-200 shrink-0"
      ...
      {selectedFile && (
        <div className="mt-3 flex justify-end">
          <button
            ...
            disabled={uploading}
            onClick={onUpload}
            className="inline-flex items-center justify-center rounded-lg bg-emerald-500 px-5 py-2 text-xs font-semibold text-slate-950 hover:bg-emerald-400 disabled:opacity-60 disabled:cursor-not-allowed transition-colors duration-200 min-w-[120px]"
          >
            {uploading ? (
              <>
